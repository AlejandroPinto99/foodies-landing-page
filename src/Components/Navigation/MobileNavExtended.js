                ...
                <div className="h-3/5 w-full bg-white rounded-b-2xl ">
                    ...
                    <div className="h-2/4 mt-4">
                      <ul className="flex flex-col ml-4 justify-between h-full ">
                          <li>
                            <a href="#acerca_de" className="font-syne-bold text-2xl link">Acerca de</a> 
                          </li>
                          <li>
                            <a href="#restaurantes" className="font-syne-bold  text-2xl link">Restaurantes</a> 
                          </li>
                          <li>
                            <Link to="/menu" className="font-syne-bold  text-2xl link">Menu</Link> 
                          </li>
                          <li>
                            <a href="#contact" className="font-syne-bold  text-2xl link">Contáctanos</a> 
                          </li>
                      </ul>
                    </div>
                </div>
