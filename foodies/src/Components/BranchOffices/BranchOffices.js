        ...
        <div>
            ...
            <div className="flex flex-row justify-center border border-gray-300 lg:w-6/12">
                <button className={`flex flex-row justify-center w-6/12 font-syne-bold 
                    ...
                    <svg  width="20%" height="40" viewBox="0 0 18 18" stroke={`${(type===`takeaway`) ? 'none' : 'black'}`} xmlns="http://www.w3.org/2000/svg"
                        className="mx-3 stroke-1">
                ...
                <button className={`flex flex-row justify-center items-center 
                    ...
                    <svg width="20%" height="40" viewBox="0 0 30 18" stroke={`${(type===`delivery`) ? 'white' : 'black'}`} xmlns="http://www.w3.org/2000/svg"
                        className="mx-3 stroke-1">
